...
export function setSongList(newList) {
  songList = newList;
}

// Lire une chanson sur laquelle on clique
export function playSong(song, songs) {
...
playerProgress.addEventListener('change', evt => {
  audioPlayer.currentTime = evt.currentTarget.value;
})
